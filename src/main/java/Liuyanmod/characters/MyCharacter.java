...
public class MyCharacter extends CustomPlayer {
    // 火堆的人物立绘（行动前）
    private static final String MY_CHARACTER_SHOULDER_1 = "images/characters/defect/shoulder2.png";
    // 火堆的人物立绘（行动后）
    private static final String MY_CHARACTER_SHOULDER_2 = "images/characters/defect/shoulder2.png";
    // 人物死亡图像
    private static final String CORPSE_IMAGE = "Liuyan/img/chars/Liuyan.png";
    // 战斗界面左下角能量图标的每个图层
    ...
    public MyCharacter(String name) {
        super(name,MY_CHARACTER,ORB_TEXTURES,"Liuyan/img/cardui/energy_relic.png", LAYER_SPEED, null, null);
        ...
        this.initializeClass(
                "Liuyan/img/chars/Liuyan.png", // 人物图片
    ...
    public String getLocalizedCharacterName() {
        return characterStrings.NAMES[0]="刘焉";
    }
